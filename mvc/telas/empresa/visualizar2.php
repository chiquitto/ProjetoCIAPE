<?php
$empresa = $this->dados['empresa']->getAll();

//print_r($empresa); exit;

$numOrdem = $empresa['numOrdem'];
$e_razaoSocial = $empresa['e_razaoSocial'];
$e_cnpj = $empresa['e_cnpj'];
$e_dtFundacao = $empresa['e_dtFundacao'];
$e_ramoAtividade = $empresa['e_ramoAtividade'];
$e_endereco = $empresa['e_endereco'];
$e_bairro = $empresa['e_bairro'];
$e_cep = $empresa['e_cep'];
$e_cidade = $empresa['e_cidade'];
$e_uf = $empresa['e_uf'];
$e_fone = $empresa['e_fone'];
$e_email = $empresa['e_email'];

if (isset($empresa['m_atendimento'])) {
    $m_atendimento = 1;
}

if (isset($empresa['m_estacionamento'])) {
    $m_estacionamento = 1;
}

if (isset($empresa['m_preco'])) {
    $m_preco = 1;
}

if (isset($empresa['m_variedade'])) {
    $m_variedade = 1;
}

if (isset($empresa['m_espacoFisico'])) {
    $m_espacoFisico = 1;
}

if (isset($empresa['m_localizacao'])) {
    $m_localizacao = 1;
}

if (isset($empresa['m_qualidade'])) {
    $m_qualidade = 1;
}

if (isset($empresa['m_outros'])) {
    $m_outros = 1;
}

$m_descricaoOutrosPontosFortes = $empresa['m_descricaoOutrosPontosFortes'];

if (isset($empresa['m_mAtendimento'])) {
    $m_mAtendimento = 1;
}

if (isset($empresa['m_mEstacionamento'])) {
    $m_mEstacionamento = 1;
}

if (isset($empresa['m_mPreco'])) {
    $m_mPreco = 1;
}

if (isset($empresa['m_mVariedade'])) {
    $m_mVariedade = 1;
}

if (isset($empresa['m_mEspacoFisico'])) {
    $m_mEspacoFisico = 1;
}

if (isset($empresa['m_mLocalizacao'])) {
    $m_mLocalizacao = 1;
}

if (isset($empresa['m_mQualidade'])) {
    $m_mQualidade = 1;
}

if (isset($empresa['m_mOutros'])) {
    $m_mOutros = 1;
}

$m_mOutrosPontosDescricao = $empresa['m_mOutrosPontosDescricao'];

if (isset($empresa['m_promocao'])) {
    $m_promocao = $empresa['m_promocao'];
}

if (isset($empresa['m_radio'])) {
    $m_radio = 1;
}

if (isset($empresa['m_jornal'])) {
    $m_jornal = 1;
}

if (isset($empresa['m_panfleto'])) {
    $m_panfleto = 1;
}

if (isset($empresa['m_OutrosMeiosComunicacao'])) {
    $m_OutrosMeiosComunicacao = 1;
}

$m_OutrosMeiosComunicacaoDesc = $empresa['m_OutrosMeiosComunicacaoDesc'];

if (isset($empresa['p_formacaoPreco'])) {
    $p_formacaoPreco = $empresa['p_formacaoPreco'];
}

$p_outraFormacaoPreco = $empresa['p_outraFormacaoPreco'];

if (isset($empresa['p_precoConcorrencia'])) {
    $p_precoConcorrencia = $empresa['p_precoConcorrencia'];
}

if (isset($empresa['v_seg'])) {
    $v_seg = 1;
}

if (isset($empresa['v_ter'])) {
    $v_ter = 1;
}

if (isset($empresa['v_qua'])) {
    $v_qua = 1;
}

if (isset($empresa['v_qui'])) {
    $v_qui = 1;
}

if (isset($empresa['v_sex'])) {
    $v_sex = 1;
}

if (isset($empresa['v_sab'])) {
    $v_sab = 1;
}

if (isset($empresa['v_dom'])) {
    $v_dom = 1;
}

if (isset($empresa['v_manha'])) {
    $v_manha = 1;
}

if (isset($empresa['v_tarde'])) {
    $v_tarde = 1;
}

if (isset($empresa['v_noite'])) {
    $v_noite = 1;
}

if (isset($empresa['v_cheque'])) {
    $v_seg = 1;
}

if (isset($empresa['v_ticket'])) {
    $v_ter = 1;
}

if (isset($empresa['v_cartao'])) {
    $v_qua = 1;
}

if (isset($empresa['v_avista'])) {
    $v_qui = 1;
}

if (isset($empresa['v_caderneta'])) {
    $v_sex = 1;
}

if (isset($empresa['v_outraFormaPagto'])) {
    $v_sab = 1;
}
?>
