...
?>
        ...
        <form action="cadastrar-empresas.php" method="POST" role="form">
          <div class="form-group">
            ...
            <label>CNPJ:</label><input type="text" name="e_cnpj" value="" size=25><br><br>

            <label>Data de Fundação:</label><input type="text" name="e_dtFundacao" value="" size=15>

            <label>Ramo de Atividade:</label><input type="text" name="e_ramoAtividade" value="" size=30><br><br>

            <label>Endereço:</label><input type="text" name="e_endereco" value="" size=50>

            <label>Bairro:</label><input type="text" name="e_bairro" value="" size=15><br><br>

            <label>CEP:</label><input type="text" name="e_cep" value="" size=15>

            <label>Cidade:</label><input type="text" name="e_cidade" value="" size=40>

            <label>UF:</label><input type="text" name="e_uf" value="" size=5><br><br>

            <label>Fone:</label><input type="text" name="e_fone" value="" size=20>

            <label>E-mail:</label><input type="text" name="e_email" value="" size=45><br><br>
            ...
            <div class="container">
                ...
                <label><th class="span1"><input type="checkbox" name = "m_outros" value = "1"></th>
                    <td>Outros:<input type="text" name="m_descricaoOutrosPontosFortes" value="" size=20><br></td></label>
                </tr>
                ...
                <label><th class="span1"><input type="checkbox" name = "m_mOutros" value = "1"></th>
                    <td>Outros:<input type="text" name="m_mOutrosPontosDescricao" value="" size=20><br></td></label>
                </tr>
                ...
                <tr>
                <label><br><th class="span1"><input type="radio" name = "p_formacaoPreco" value = "2"></th>
                   <td>Outra Maneira, Qual?<input type="text" name="p_outraFormacaoPreco" value="" size=20></td></label>
                </tr><br><br>
